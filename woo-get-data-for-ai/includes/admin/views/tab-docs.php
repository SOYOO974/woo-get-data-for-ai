...
<div class="agent-bridge-card">
    ...
    <p class="description">
        <?php esc_html_e('WP Agent Bridge is more than raw endpoints: it embeds 7 structured MECE Master Playbooks and dynamically generates ready-to-use AI skills.', 'woo-get-data-for-ai'); ?>
    </p>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 15px; margin-top: 15px;">
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 15px;">
            <h4 style="margin-top: 0; color: #059669; display: flex; align-items: center; gap: 6px;">
                ...
                <?php esc_html_e('7 MECE Master Audit Playbooks', 'woo-get-data-for-ai'); ?>
            </h4>
            <p style="font-size: 13px; color: #475569; margin: 0;">
                <?php esc_html_e('Organized into 7 Strategic MECE Master Pillars: 360° SEO & Content, Agency Performance & Core Web Vitals, System Health & Database Bloat Hygiene, Orders & Checkout Troubleshooting, 360° E-Commerce Sales & Analytics, Shipping Logistics & Flexible Shipping, and Code Architecture & Automations Map.', 'woo-get-data-for-ai'); ?>
            </p>
        </div>
