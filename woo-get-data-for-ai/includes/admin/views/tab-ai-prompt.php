...
$mega_prompt .= "   - **Pillar 1: SEO, Content, Redirections & Visibility** -> Playbook `seo_content_audit` (queries `/content/seo-audit`, `/content/seo/settings`, `/content/pages`, `/content/page/{id}`, `/content/redirections`, `/content/redirections/404`).\n";
...
$mega_prompt .= "   - **Pillar 4: Orders, Checkout & Gateway Troubleshooting** -> Playbook `order_checkout_troubleshoot` (queries `/woocommerce/orders`, `/woocommerce/order/{id}`, `/woocommerce/payment-logs`, `/logs/view`, `/snippets`, `/system/mail`, `/woocommerce/webhooks`).\n";
...
$mega_prompt .= "  * Auditing SEO (Rank Math, Yoast, The SEO Framework, SEOPress), plugin settings, redirect rules, or 404 logs? -> Check `/content/seo-audit`, `/content/seo/settings`, `/content/redirections`, or `/content/redirections/404`.\n";
...
$mega_prompt .= "  * Investigating orders, payment errors, coupons, cancellation ratios, or checkout hooks? -> Check `/woocommerce/payment-logs?gateway=all&level=error`, `/woocommerce/orders?status=failed,processing` (supports `?coupon=<code>`), `/woocommerce/order/{id}`, `/woocommerce/coupons` or `/woocommerce/coupon/{id}` (real-time availability, held sessions, associated orders) and `/woocommerce/summary`.\n";
