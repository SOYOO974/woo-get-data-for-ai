...
1. **360° SEO, Content Hierarchy, Redirections & Visibility Audit** (`seo_content_audit`): Runs `/content/seo-audit`, analyzes `/content/pages`, inspects `/content/page/{id}` for flagged URLs, Gutenberg block structures, and meta tags, and audits configured 301/302/410 redirect rules and 404 error logs with `/content/redirections` and `/content/redirections/404`.
