...
| `GET /woocommerce/settings` | Store configuration: currency, tax settings, stock management, active payment gateways (secrets redacted), shipping zones/methods with locations, flat_rate table rate rules, Flexible Shipping matrix rules, and personal data retention policies (`data_retention`). |
